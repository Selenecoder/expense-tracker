package com.example.vyaysigh.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthenticationFilter.class); // Added logger for
                                                                                                 // debugging
    ...
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            logger.warn("No valid user found in token: {}", userEmail);
        }
